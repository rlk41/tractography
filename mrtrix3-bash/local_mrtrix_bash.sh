...
#for f in MR*; do bash /media/richard/camcan/bin/hcp-tractography/mrtrix3-bash/local_mrtrix_bash.sh ${f} ${inDir} ${outDir}; done
...
python '/media/richard/camcan/bin/hcp-tractography/mrtrix3-bash/mrtrix3.sh' \
--subNum     "$subID" \
--subsDir    "$outDir" \
